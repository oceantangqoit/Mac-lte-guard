...
内置 **62 种语言**。菜单中按「汉语及其方言 → 中国少数民族语言 → 其他语言」排序：

| 分组 | 语言 |
|---|---|
| 汉语及方言 | 简体中文、繁體中文、粵語、閩南語、潮汕話、客家話、吳語、文言 |
| 中国少数民族语言 | བོད་ཡིག（藏语）、ئۇيغۇرچە（维吾尔语）、ᠮᠣᠩᠭᠣᠯ ᠪᠢᠴᠢᠭ（传统蒙古文）、한국어（朝鲜语）、Қазақша（哈萨克语） |
...
- **各汉语方言**的书面形式差异很大：粤语有成熟的书面粤文传统，闽南语、客家语可用汉字书写但用字尚未完全统一，吴语的书写规范仍在发展中。本项目选择用汉字书写，个别用字若不符合当地习惯，欢迎指正。
