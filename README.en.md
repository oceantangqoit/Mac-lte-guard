...
- 🌍 **Multilingual** — from Chinese dialects to minority languages; UI and logs fully localized, follows your system language, switchable from the menu
...
| Language | Switch the language; the submenu can edit the current language or open the language folder |
...
A wide range of languages ships with the app. The menu lists Chinese and its varieties first, then other languages by code.
